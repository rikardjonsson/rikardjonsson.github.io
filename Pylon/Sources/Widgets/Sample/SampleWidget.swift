    ...
    private func xlargeLayout(theme: any Theme) -> some View {
        HStack(spacing: 24) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                Text("This sample widget showcases the flexible container system that powers all Pylon widgets. Each widget is designed as a container where content can be dynamically swapped and resized.")
                    .font(.body)
                    .foregroundColor(theme.textSecondary)
...
struct SampleConfigurationView: View {
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text("This widget demonstrates the container architecture. Configuration options would appear here for real widgets.")
